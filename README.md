...
- 💫 **Efek MorphSVG** pada bentuk elemen SVG
- 🔥 **Efek Glitch & Energi Pulse** untuk nuansa futuristik
- ✨ **Partikel Cahaya Acak (Spark)** yang menyala dinamis
...
| Komponen | Deskripsi |
|-----------|------------|
| **HTML5 / SVG** | Struktur dasar visual dan elemen grafis jam |
| **CSS3** | Efek warna tema dan transisi antar mode |
| **JavaScript (ES6)** | Logika animasi dan kontrol waktu |
